    ...
    <section class="container p-4 mt-5 rounded-4" style="background-color: #cfe2ff">
        ...
        <div class="d-flex justify-content-between align-items-start mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('teacher.content.update', $content->id) }}" class="btn btn-warning">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mt-4 p-3 bg-light rounded">
                                        <small class="text-muted">
                                            ...
                                            Arquivo: {{ basename($content->file_path) }}
                                        </small>
                                    </div>
                                </div>
                                @else
            ...
            <div class="col-12 col-lg-4">
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <strong><i class="fas fa-sync me-2 text-primary"></i>Atualizado em:</strong>
                        ...
                        <div class="mt-4 p-3 bg-light rounded">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ route('teacher.content.update', $content->id) }}" 
                                   class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit me-1"></i>Editar Conteúdo
                                </a>
                                <button type="button" 
                                        class="btn btn-danger btn-sm"
                                        onclick="if(confirm('Tem certeza que deseja excluir este conteúdo?')) { document.getElementById('delete-form').submit(); }">
                                    <i class="fas fa-trash me-1"></i>Excluir Conteúdo
                                </button>
                            </div>
                        </div>
                    </div>
